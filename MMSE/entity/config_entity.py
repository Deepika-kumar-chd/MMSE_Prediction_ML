...
import os 
from MMSE.constant import training_pipeline
...
class DataTransformationConfig:
    ...
    def __init__(self, training_pipeline_config:TrainingPipelineConfig):
        ...
        self.transformed_object_file_path:str = os.path.join(
            self.data_transformation_dir,
            training_pipeline.DATA_TRANSFORMATION_TRANDFORMED_OBJECT_DIR,
...
class ModelTrainerConfig:
    ...
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.expected_R2: float = training_pipeline.MODEL_TRAINER_EXPECTED_SCORE
...
class ModelPusherConfig:
    ...
    def __init__(self,training_pipeline_config:TrainingPipelineConfig):
        ...
        self.model_eval_dir: str = os.path.join(
            training_pipeline_config.artifact_dir,
